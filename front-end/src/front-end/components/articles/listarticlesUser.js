...
import ConfirmationDeconnecter from "../users/deconnexion";
        ...
        <Grid padded className="tablet computer only">
          <Menu className="a" borderless inverted fluid fixed="top">
            ...
            <Menu.Menu position="right">
              ...
              <Menu.Item  as="a">
              <i class="signal icon"></i>&nbsp; <UserS nom={this.state.id} />
</Menu.Item>
            </Menu.Menu>
          </Menu>
        </Grid>
...
:el.colection===this.state.valuecol && el.reference.includes(this.state.ref))
...
:el.mesures===this.state.valuemesure&& el.reference.includes(this.state.ref))
...
:
articles.filter(el=> this.state.valuenom==="nom"? <Article nameUser={this.state.id} key={el.id} el={el} />  :el.name===this.state.valuenom).filter(el=> this.state.valuecol==="Collection"? el=> 
<Article nameUser={this.state.id} key={el.id} el={el} />  :el.colection===this.state.valuecol).filter(el=> this.state.valuetype==="Type"? 
<Article nameUser={this.state.id} key={el.id} el={el} />  :el.type===this.state.valuetype).filter(el=> this.state.valuemesure==="Mesure"? 
<Article nameUser={this.state.id} key={el.id} el={el} />  :el.mesures===this.state.valuemesure).filter(el=> this.state.valuequantity==="Quantité"? 
<Article nameUser={this.state.id} key={el.id} el={el} />  :el.quantity===this.state.valuequantity).filter(el=> this.state.valuecouleur==="Couleur"? 
<Article nameUser={this.state.id} key={el.id} el={el} />  :el.couleur===this.state.valuecouleur).filter(el=> this.state.valuephase==="Phase"?
 <Article nameUser={this.state.id} key={el.id} el={el} />  
